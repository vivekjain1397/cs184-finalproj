...
private:
    Mesh particle_mesh;
    Shader particle_shader, velocity_shader, water_shader, curvature;
    int shade_mode;
    ...
    GLuint m_dataTexture, m_thicknessTexture, m_colorTexture, m_reflectionTexture, m_curvatureFlowShader;; 
